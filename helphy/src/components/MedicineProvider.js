            ...
            <Row className="dashboard-body">
                ...
                <Col md={3} className="sidebar">
                    <Nav defaultActiveKey="/dashboard" className="flex-column" onSelect={handleSelect}>
                        ...
                        <Nav.Link href="#hospitals-management" active={activeLink === '#hospitals-management'}>
                            <div className="icon-container">
                                <FaListAlt className="icon" />
                            </div>
                            <span className="link-text">Hospitals Management</span>
                        </Nav.Link>
                        <Nav.Link href="#government-clients-management" active={activeLink === '#government-clients-management'}>
                            <div className="icon-container">
                                <FaAmbulance className="icon" />
                            </div>
                            <span className="link-text">Government Clients</span>
                        </Nav.Link>
                    </Nav>
                </Col>
                {/* Main Content */}
